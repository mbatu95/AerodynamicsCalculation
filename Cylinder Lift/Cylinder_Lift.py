# -*- coding: utf-8 -*-
"""
Created on Fri March 15 11:55:20 2019
...
def get_stream_function_doublet(strength, x1, y1, X, Y):
    """
    ...
    X: 2D np array of floats
        x-coordinate of the mesh points.
    Y: 2D np array of floats
    ...
    psi: 2D np array of floats
        The stream-function.
    """
    psi = -strength / (2 * math.pi) * (Y - y1) / ((X - x1)**2 + (Y - y1)**2)
    
    return psi
                    # freestream speed

def get_velocity_doublet(strength, x1, y1, X, Y):
    """
    ...
    Returns
    -------
    u: 2D np array of floats
        x-component of the velocity vector field.
    v: 2D np array of floats
...
#velocity field on the mesh grid
...
#stream-function on the mesh grid
